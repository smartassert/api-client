...
class GetTest extends AbstractSerializedSuiteClientTestCase
{
    ...
    public static function incompleteResponseDataExceptionDataProvider(): array
    {
        return [
            'id missing' => [
                ...
                'expectedRequestName' => 'get_serialized-suite-get',
    ...
    {
        return new ExpectedRequestProperties('GET', '/source/serialized_suite/' . self::ID);
    }
}
