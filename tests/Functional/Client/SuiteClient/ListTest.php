...
class ListTest extends AbstractSuiteClientTestCase
{
    ...
    public static function incompleteResponseDataExceptionDataProvider(): array
    {
        return [
            'id missing' => [
                'payload' => [
                    ['source_id' => self::SOURCE_ID, 'label' => self::LABEL, 'tests' => []],
                ],
                'expectedRequestName' => 'get_suites',
    ...
    {
        return new ExpectedRequestProperties('GET', '/source/suites');
    }
}
